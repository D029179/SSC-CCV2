 ...
 */
public class SapcustdevsolutionconfigfacadesWebHelper
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SapcustdevsolutionconfigfacadesWebHelper.class.getName());
