...
public class DefaultSsclibloaderService implements SsclibloaderService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSsclibloaderService.class);
	...
	{
		return DefaultSsclibloaderService.class.getResourceAsStream("/ssclibloader/sap-hybris-platform.png");
	}
