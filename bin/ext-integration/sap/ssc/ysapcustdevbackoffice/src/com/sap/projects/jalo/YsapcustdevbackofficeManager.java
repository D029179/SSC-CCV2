...
import com.sap.projects.constants.YsapcustdevbackofficeConstants;
 ...
 */
public class YsapcustdevbackofficeManager extends GeneratedYsapcustdevbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(YsapcustdevbackofficeManager.class.getName());
	 ...
	 */
	public static YsapcustdevbackofficeManager getInstance()
	{
		return (YsapcustdevbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YsapcustdevbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YsapcustdevbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of YsapcustdevbackofficeManager called.");
		}
	}
