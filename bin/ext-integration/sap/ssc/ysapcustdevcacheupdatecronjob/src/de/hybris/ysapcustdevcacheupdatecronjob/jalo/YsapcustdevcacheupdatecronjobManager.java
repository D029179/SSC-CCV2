 ...
 */
package de.hybris.ysapcustdevcacheupdatecronjob.jalo;
...
/**
 * This is the extension manager of the Ysapcustdevcacheupdatecronjob extension.
 */
public class YsapcustdevcacheupdatecronjobManager extends GeneratedYsapcustdevcacheupdatecronjobManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(YsapcustdevcacheupdatecronjobManager.class);
	 ...
	 */
	public static YsapcustdevcacheupdatecronjobManager getInstance()
	{
		return (YsapcustdevcacheupdatecronjobManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(YsapcustdevcacheupdatecronjobConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public YsapcustdevcacheupdatecronjobManager() // NOPMD 
	{
		LOG.debug("constructor of YsapcustdevcacheupdatecronjobManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of YsapcustdevcacheupdatecronjobManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of YsapcustdevcacheupdatecronjobManager called, current tenant: {}", getTenant().getTenantID());
	}
