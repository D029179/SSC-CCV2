...
/**
 * This is the extension manager of the Ysapcustdevsolutionconfigb2bfrontend extension.
 */
public class Ysapcustdevsolutionconfigb2bfrontendManager extends GeneratedYsapcustdevsolutionconfigb2bfrontendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Ysapcustdevsolutionconfigb2bfrontendManager.class.getName());
	 ...
	 */
	public static Ysapcustdevsolutionconfigb2bfrontendManager getInstance()
	{
		return (Ysapcustdevsolutionconfigb2bfrontendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Ysapcustdevsolutionconfigb2bfrontendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Ysapcustdevsolutionconfigb2bfrontendManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Ysapcustdevsolutionconfigb2bfrontendManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Ysapcustdevsolutionconfigb2bfrontendManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Ysapcustdevsolutionconfigb2bfrontendManager called, current tenant: " + getTenant().getTenantID());
		}
	}
