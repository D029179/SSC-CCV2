 ...
 *  
 */
package com.sap.projects.custdev.fbs.slc.order.jalo;
...
/**
 * This is the extension manager of the Sapcustdevordermgmgtbol extension.
 */
public class SapcustdevordermgmgtbolManager extends GeneratedSapcustdevordermgmgtbolManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcustdevordermgmgtbolManager.class.getName());
	 ...
	 */
	public static SapcustdevordermgmgtbolManager getInstance()
	{
		return (SapcustdevordermgmgtbolManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcustdevordermgmgtbolConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcustdevordermgmgtbolManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcustdevordermgmgtbolManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcustdevordermgmgtbolManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcustdevordermgmgtbolManager called, current tenant: " + getTenant().getTenantID());
		}
	}
