...
/**
 * This is the extension manager of the Sapcustdevsolutionconfigservices extension.
 */
public class SapcustdevsolutionconfigservicesManager extends GeneratedSapcustdevsolutionconfigservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcustdevsolutionconfigservicesManager.class.getName());
	 ...
	 */
	public static SapcustdevsolutionconfigservicesManager getInstance()
	{
		return (SapcustdevsolutionconfigservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcustdevsolutionconfigservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcustdevsolutionconfigservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcustdevsolutionconfigservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcustdevsolutionconfigservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcustdevsolutionconfigservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
