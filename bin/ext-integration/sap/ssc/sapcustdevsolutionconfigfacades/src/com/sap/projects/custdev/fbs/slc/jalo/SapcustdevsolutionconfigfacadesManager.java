 ...
 *  
 */
package com.sap.projects.custdev.fbs.slc.jalo;
...
import com.sap.projects.custdev.fbs.slc.constants.SapcustdevsolutionconfigfacadesConstants;



/**
 * This is the extension manager of the Sapcustdevsolutionconfigfacades extension.
 */
public class SapcustdevsolutionconfigfacadesManager extends GeneratedSapcustdevsolutionconfigfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcustdevsolutionconfigfacadesManager.class.getName());
	 ...
	 */
	public static SapcustdevsolutionconfigfacadesManager getInstance()
	{
		return (SapcustdevsolutionconfigfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcustdevsolutionconfigfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcustdevsolutionconfigfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcustdevsolutionconfigfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcustdevsolutionconfigfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcustdevsolutionconfigfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
