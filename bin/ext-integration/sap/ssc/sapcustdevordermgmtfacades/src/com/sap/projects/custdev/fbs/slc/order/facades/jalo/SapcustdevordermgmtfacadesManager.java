 ...
 *  
 */
package com.sap.projects.custdev.fbs.slc.order.facades.jalo;
...
import com.sap.projects.custdev.fbs.slc.order.facades.constants.SapcustdevordermgmtfacadesConstants;



/**
 * This is the extension manager of the Sapcustdevordermgmtfacades extension.
 */
public class SapcustdevordermgmtfacadesManager extends GeneratedSapcustdevordermgmtfacadesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SapcustdevordermgmtfacadesManager.class.getName());
	 ...
	 */
	public static SapcustdevordermgmtfacadesManager getInstance()
	{
		return (SapcustdevordermgmtfacadesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SapcustdevordermgmtfacadesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapcustdevordermgmtfacadesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapcustdevordermgmtfacadesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SapcustdevordermgmtfacadesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SapcustdevordermgmtfacadesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
