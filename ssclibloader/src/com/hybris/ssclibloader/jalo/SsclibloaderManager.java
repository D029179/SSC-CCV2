 ...
 */
package com.hybris.ssclibloader.jalo;
...
/**
 * This is the extension manager of the Ssclibloader extension.
 */
public class SsclibloaderManager extends GeneratedSsclibloaderManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SsclibloaderManager.class);
	 ...
	 */
	public static SsclibloaderManager getInstance()
	{
		return (SsclibloaderManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SsclibloaderConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SsclibloaderManager() // NOPMD 
	{
		LOG.debug("constructor of SsclibloaderManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SsclibloaderManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SsclibloaderManager called, current tenant: {}", getTenant().getTenantID());
	}
