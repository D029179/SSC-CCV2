...
<div id="cartItems" class="clear">
	<div class="headline">
		<h4><spring:theme code="sapcustdev.solutionconfig.listrelatedproducts.title"/></h4>
		<span class="cartId"/>
	</div>
	...
	<table class="cart">
		<thead>
			<tr>
				<th id="header2" colspan="2" style="color:#fff;"><spring:theme code="basket.page.title"/></th>
				<th id="header3" style="color:#fff;"><spring:theme code="basket.page.itemPrice"/></th>
				<th id="header4" style="color:#fff;"><spring:theme code="sapcustdev.solutionconfig.listrelatedproducts.columns.actions"/></th>
			</tr>
		</thead>
		<tbody>
